      ...
      <div class="subnav  js-subnav">
        ...
        <div class="subnav__wrapper js-subnav__wrapper">
          <nav class="subnav__nav justify-left">
            ...
            <button class="btn btn--primary" aria-controls="modal-full-width">Add</button>
            ...
            <menu class="menu-bar menu-bar--expanded@md js-menu-bar">
                ...
                <li class="menu-bar__item" role="menuitem">
                  <svg class="icon menu-bar__icon" aria-hidden="true" width="30" height="30" viewBox="0 0 24 24"><title>archive-2</title><g fill="#969696"><path fill="#969696" d="M21,8H3C2.448,8,2,8.447,2,9v14c0,0.553,0.448,1,1,1h18c0.552,0,1-0.447,1-1V9C22,8.447,21.552,8,21,8z M17,15c0,0.553-0.448,1-1,1H8c-0.552,0-1-0.447-1-1v-3h2v2h6v-2h2V15z"></path> <rect x="4" y="4" width="16" height="2"></rect> <rect x="7" width="10" height="2"></rect></g></svg>
                ...
                <li class="menu-bar__item" aria-controls="modal-search">
                    <svg class="icon menu-bar__icon" aria-hidden="true" width="24" height="24" viewBox="0 0 24 24"><title>zoom-2</title><g stroke-linecap="square" stroke-linejoin="miter" stroke-width="1" transform="translate(0.5 0.5)" fill="#969696" stroke="#969696"><line fill="none" stroke-miterlimit="10" x1="22" y1="22" x2="16.4" y2="16.4"></line> <circle fill="none" stroke="#969696" stroke-miterlimit="10" cx="10" cy="10" r="9"></circle></g></svg>
              ...
              <p class="hide@md no-js:is-hidden"><button class="btn btn--primary" aria-controls="sidebar">sidebar</button></p>
