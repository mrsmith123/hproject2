...
var scriptsJsPath = 'resources/js'; //folder for final scripts.js/scripts.min.js files

// css file paths
var cssFolder = 'resources/sass'; // folder for final style.css/style-custom-prop-fallbac.css files
